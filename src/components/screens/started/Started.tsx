...
const Started = () => {
    ...
    return(
        <div className="started">
            <p className="started__boldtext">Getting started</p>
            <p className="started__slimtext">
                Eu, molestie commodo, enim pellentesque turpis integer sagittis
            </p>
            <div className="started__items">
                <div className="started__itemwrapper">
                    ...
                    <p className='started__item-text'>Connect your wallet</p>
                </div>
                <div className="started__itemwrapper">
                    <div className="started__item">
                        <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36">
                    ...
                    <p className='started__item-text'>Posuere urna, sit amet molestie leo</p>
                </div>
                <div className="started__itemwrapper">
                    <div className="started__item">
                        <svg
                    ...
                    <p className='started__item-text'>Semper pretium libero sed quam ac integer ut</p>
                </div>
                <div className="started__itemwrapper">
                    <div className="started__item">
                        <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36">
                    ...
                    <p className='started__item-text'>Lectus volutpat magna vitae in arcu</p>
                </div>
            </div>
      </div>
    )
